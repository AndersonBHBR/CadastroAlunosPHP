...
<html>
    ...
    <body>
        ...
        <div id="formulario">
            ...
            ?>
            <form name="formulario" action="excluir.php" method="POST">
            ...
            <form name="formulario" action="index.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nome" disabled value="<?php echo $nome ?>" placeholder="Nome completo do aluno">
                </div>
                <div class="form-group">
                    <label>Endereço</label>
                    <input type="text" class="form-control" disabled value="<?php echo $endereco ?>" name="endereco" placeholder="Endereço onde mora o aluno">
                </div>
                <div class="form-group">
                    <label>Turma</label>
                    <input type="text" class="form-control" disabled value="<?php echo $turma ?>" name="turma" placeholder="Turma onde o aluno ira estudar">
                </div>
                <br>
